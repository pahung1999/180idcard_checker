...
# Load the ONNX model
model = onnx.load("./weight/mobilenet_v3_small_lastest_w224_h224.onnx")
...
session = onnxruntime.InferenceSession("./weight/mobilenet_v3_small_lastest_w224_h224.onnx", providers=providers)
...
for filename in os.listdir(image_folder):
    ...
    print(f"{filename}: {predicted_label_index}" )